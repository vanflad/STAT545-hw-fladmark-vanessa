...
```
A visual representation of numerical data is a frequency histogram
Displays same info as summary but is easier to see distribution
...
```
From this scatterplot we can see that GDP per capita is increasing
(With the exception of a few outliers in the earlier years)
